...
const (
	...
	ABM_ACTIVATE         = 0x0006
	ABM_GETAUTOHIDEBAR   = 0x0007
	ABM_SETAUTOHIDEBAR   = 0x0008
	ABM_WINDOWPOSCHANGED = 0x0009
	ABM_SETSTATE         = 0x000A
	...
	DL_COPYCURSOR = 0x0002
	DL_CURSORSET  = 0x0000
	DL_DRAGGING   = 0x0486
	DL_DROPPED    = 0x0487
	DL_MOVECURSOR = 0x0003
	DL_STOPCURSOR = 0x0001
